    ...
    <div>
        ...
        <div className="bg-white w-2/4 absolute left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 rounded-lg">
            ...
            <form className='flex flex-col p-5' onSubmit={addTeam}>
                <input className='p-4 bg-lavender-100 outline-none border focus:border-color-tertiary my-5 rounded-md' name='name' placeholder='Name...' type="text" required/>
                <input className='p-4 bg-lavender-100 outline-none border focus:border-color-tertiary my-5 rounded-md' name='img' placeholder='Image...' type="text" />
                <input className='p-4 bg-lavender-100 outline-none border focus:border-color-tertiary my-5 rounded-md' name='description' placeholder='Description...' type="text" required/>
